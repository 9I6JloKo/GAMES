    ...
    public void run() {
        ...
        while(repeat == true){
            ...
            switch (task) {
                ...
                case 10:
                    System.out.println("За какой месяц хотите счет? 1) Январь\n2) Февраль\n3) Март\n4) Апрель\n5) Май\n6) Июнь\n7) Июль\n8) Август\n9) Сентябрь\n10) Октябрь\n11) Ноябрь\n12) Декабрь\n-->");    
                    byte month = scanner.nextByte();
                    switch(month){
                        case 1:
                            for (int i = 0; i< histories.size();i++){
                                if (histories.get(i) != null && 0 == histories.get(i).getDateOfBuying().getMonth()){
                                    System.out.println(histories.get(i).toString());
                                }
                            }
                    }
        ...
        if (products.get(0) != null){
            ...
            switch(otvetproduct1){
                ...
                case 4: 
                    ...
                    products.get(otvetproduct-1).setSize(scanner.nextInt());scanner.nextLine();
                    break;
                case 5:
        ...
        if (clients.get(0) != null){
            ...
            switch(otvetclient1){
                case 1:
                    ...
                    clients.get(otvetclient-1).setClientName((String) scanner.nextLine());
                    break;
                case 2:
                    System.out.println("Фамилия - ");scanner.next();

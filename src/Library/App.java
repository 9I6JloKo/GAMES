...
//                    System.out.println("Еще не сделано");
    ...
    public void changeBook(){
        int apostrof = 1;
        while(apostrof == 1){
            if (booksArray.get(0) != null){
                for(int i = 0; i < booksArray.size(); i++){
                    if(booksArray.get(0) != null){
                        System.out.println((i+1) + ")" + booksArray.get(i).toString());
                    }
                }   
                System.out.println("Какой какую хотите изменить?");
                ...
                switch(otvetproduct1){
                    case 1:
                        ...
                        booksArray.get(otvetproduct-1).setTitle(scanner.nextLine());
                        break;
                    case 2:
                        System.out.println("Автор - ");
                        List<Author> authors1 = new ArrayList<>();
                        authors1.add(addAuthor());
                        booksArray.get(otvetproduct-1).setAuthors(authors1);
                        break;
                    case 3:
                        System.out.println("Год издания - "); 
                        booksArray.get(otvetproduct-1).setPublishYear(inputInt());scanner.nextLine();
                        break;
                    case 4: 
                        System.out.println("Кол-во - "); 
                        booksArray.get(otvetproduct-1).setCount(inputInt());scanner.nextLine();
                        break;
                    default:
                ...
                System.out.println("Массив книг пуст");
            }
            System.out.println("Повторить изменение? да - 1, нет - 2"); apostrof = inputInt();
            if(apostrof == 2){
                break;
            }
        }
    ...
    private void changeReader(){
        int apostrof = 1;
        while(apostrof == 1){
            if (readersArray.get(0) != null){
                for(int i = 0; i < readersArray.size(); i++){
                    if(readersArray.get(0) != null){
                        System.out.println((i+1) + ")" + readersArray.get(i).toString());
                    }
                }   
                System.out.println("Какого читателя хотите изменить?");
                ...
                switch(otvetclient1){
                    case 1:
                        ...
                        readersArray.get(otvetclient-1).setFirstname(scanner.nextLine());
                        break;
                    case 2:
                        System.out.println("Фамилия - ");
                        readersArray.get(otvetclient-1).setSurename(scanner.nextLine());
                        break;
                    case 3:
                        System.out.println("Номер телефона - ");
                        readersArray.get(otvetclient-1).setPhoneNumber(scanner.nextLine());
                        break;
                    default:
                        System.out.println("Error");
                }
            ...
            System.out.println("Повторить изменение? 1 - да, 2 - нет"); apostrof = inputInt();
            if(apostrof == 2){
                break;
            }
